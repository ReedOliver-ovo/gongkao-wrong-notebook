...
export async function POST(req: Request) {
    ...
    try {
        ...
        logger.info({ subjectId }, 'Calling AI service for civil-service image analysis');
        const aiService = getAIService();
        const analysisResult = await aiService.analyzeImage(imageBase64, mimeType, language, null, null, null);
